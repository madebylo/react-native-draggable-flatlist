...
import Animated, { runOnJS, useAnimatedReaction, useAnimatedScrollHandler, useSharedValue, withSpring, useAnimatedRef //@madebylo
...
function DraggableFlatListInner(props) {
  ...
  const flatlistAnimatedRef = useAnimatedRef(); //@madebylo
  ...
  const pointerY = useSharedValue(null); //@madebylo
